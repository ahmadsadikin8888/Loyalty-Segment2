...
class Sys_dok_user_model extends CI_Model {
    protected $tbl;
    protected $limit = 0;
    protected $offset = 10;
    ...
    public function get_by_id($id){
		$afield = array(
			...
			'Privilage.id as Privilage_id',
			'Privilage.nmlevel as nmlevel',
			'Privilage.opt_status as Privilage_opt_status',
			'Status.id as Status_id',
			'Status.status as status',
		
		);
		$this->db->select($afield);
		$this->db->join('sys_level Privilage','Privilage.id=sys_user.opt_level','LEFT'); 
