...
<div class="col-sm-12 col-lg-12">
    <!-- <div class="alert alert-icon alert-success" role="alert">
        <i class="fe fe-check mr-2" aria-hidden="true"></i><small>Step 1. Pastikan Template disesuaikan dengan Pilihan Sumber</small><br>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Upload File <?php echo $dok->dok; ?></h3>
        </div>
        <div class="card-body">
            <div class="dimmer" id="box-upload">
                ...
                <div class="dimmer-content">
                    <form id="form-a">
                        ...
                        <input type="hidden" id="dok" name="dok" value="<?php echo $dok->id;?>">
