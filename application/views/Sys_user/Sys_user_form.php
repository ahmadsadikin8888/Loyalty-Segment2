...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'> 
							...
							<?php $v='';  if(isset($data)) $v = $data->opt_level; 
								  echo create_cmb_database(array(	'id'			=>'opt_level',
																	'name'			=>'opt_level',
																	'table'			=>'sys_level',
																	'field_show'	=>'nmlevel',
																	'primary_key'	=>'id', 
					...
					<div class='form-group'> 
							...
							<?php $v='';  if(isset($data)) $v = $data->opt_status; 
								  echo create_cmb_database(array(	'id'			=>'opt_status',
																	'name'			=>'opt_status',
																	'table'			=>'sys_status',
																	'field_show'	=>'status',
																	'primary_key'	=>'id', 
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->sys_user_address ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='address' name='address' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->address ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->sys_user_phone ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='phone' name='phone' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->phone ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->sys_user_name ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->sys_user_email ?></label>
